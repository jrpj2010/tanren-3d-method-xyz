...
import { saveDailyChallenge } from "@/lib/user-progress"
...
export default function DailyChallengeQuiz() {
  ...
  const handleNextQuestion = () => {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      // デイリーチャレンジ終了、結果を保存
      saveDailyChallenge(score, questions.length)
      router.push(`/results?score=${score}&total=${questions.length}&genre=daily&difficulty=mixed`)
    }
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <h1 className="text-2xl font-bold text-center mb-6">デイリーチャレンジ</h1>
